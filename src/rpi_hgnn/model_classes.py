...
#使用 max mean sortpooling set2set
class Model_1(torch.nn.Module):
    def __init__(self, num_node_features, num_relations,num_bases, num_of_classes=2):
        ...
        #self.lin1 = torch.nn.Linear(128 * 5, 128)
        #self.lin1 = torch.nn.Linear(128*4, 128)
        self.lin1 = torch.nn.Linear(128*5, 128)
        #self.lin1 = torch.nn.Linear(128 * 1, 128)
    ...
    def forward(self, data):
        ...
        res1_1= torch.cat([global_max_pool(x_t,batch_t), global_mean_pool(x_t,batch_t)], dim=1) #添加残差模块
        ...
        res2_1 = torch.cat([global_max_pool(x_t,batch_t), global_mean_pool(x_t,batch_t)], dim=1) #添加残差模块
...
class Model_2(torch.nn.Module):
    def __init__(self, num_node_features, num_relations,num_bases, num_of_classes=2):
        ...
        self.pool3_3 = TopKPooling(128, ratio=0.5)
        self.global_3 = global_sort_pool
        #self.global_3 = Set2Set(128, processing_steps=3, num_layers=1)
        #链接预测
        #self.lin1 = torch.nn.Linear(128 * 5, 128)
        #self.lin1 = torch.nn.Linear(128 * 5, 128)
        #self.lin1 = torch.nn.Linear(128*4, 128)
    ...
    def forward(self, data):
        ...
        #全连接层
        x= torch.cat([res1_1+res2_1+res3_1,res1_2+res2_2+res3_2,res1_3+res2_3+res3_3],dim=1) #加入残差
        #x = torch.cat([res3_1,res3_2,res3_3], dim=1)
